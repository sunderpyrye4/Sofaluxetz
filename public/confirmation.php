...
<html>
  <head>
    ...
    <title>Sofaluxetz | Request accepted!</title>

    <meta property="og:title" content="Sofaluxetz | Request accepted!" />
    <meta property="og:image" content="brand.svg" />
    
    <meta property="og:description" content="Sofaluxetz | Request accepted!" />
    <meta name="description" content="Sofaluxetz | Request accepted!" />
...
<style>
	* {
	...
	.bodyClass1-product__popupjk{
		background: #f8fff7;
		color: #000000;
	}
	.bodyClass2-product__popupjk{
		background: #e4bad4;
		color: #fff;
	}
	.bodyClass3-product__popupjk{
		background: #fff;
		color: #111;
	}
	.wrapage-block-product__popupjk{
		background-size: 100%;
		width: 100%;
	}
	.box_main-product__popupjk{
		width: 100%;
		margin: 0 auto;
		text-align: center;
		display: flex;
	...
	.box_main-product__popupjk h2{
		font-size: 24px;
		padding: 0px 0px 25px;
	}
	.box_main-product__popupjk p{
		font-weight: 500;
		font-size: 18px;
	}
	p{
	...
	.mainBlock-product__popupjk{
		text-align: start;
	}
	.mainBlock-product__popupjk ul{
		text-align: start;
		padding: 20px;
		display: flex;
		flex-direction: column;
	...
	.mainBlock-product__popupjk ul>li span{
		font-weight: bold;
	}
	.mainBlock-product__popupjk{
		max-width: 999px;
	...
	.mainBlock-product__popupjk .cBlock-product__popupjk{
		text-align: start;
	}

	.bodyClass3-product__popupjk .mainBlock-product__popupjk{
		background: none;
		border-top: 2px solid #e4bad4;
		border-bottom: 2px solid #e4bad4;
	}
	.bodyClass2-product__popupjk .mainBlock-product__popupjk{
		background: #3E432E;
		color: #fff !important;
		box-shadow: 0px 0px 0px #3E432E;
	}
	.bodyClass2-product__popupjk .mainBlock-product__popupjk p{
		color: #fff !important;
	}
	.bodyClass1-product__popupjk .mainBlock-product__popupjk{
		background: #ffffff;
		color: #000000;
		border-left: 5px solid #5454C5;
	}
	.bodyClass1-product__popupjk .mainBlock-product__popupjk p{
		color: #000000 !important;
	}
	.order-product__popupjk{
...
<div class="bodyClass1-product__popupjk" id="mainWrapp-product__popupjk">


	<div class="wrapage-block-product__popupjk">
		<div class="box_main-product__popupjk">
			<div class="mainBlock-product__popupjk">
...
<p class="cBlock-product__popupjk">With heartfelt thanks and warm wishes!</p>
			</div>
		</div>
	</div>
